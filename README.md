...
<table>
  ...
  <tr>
    <td><strong>LLM and RAG audit output</strong><br>
      <a href="docs/images/rag-check.png">
        <img src="docs/images/rag-check.png" alt="RAG security audit output" width="560">
      </a>
    </td>
...
- [Fairness audit walkthrough](packages/rai-check-ml/examples/ml_fairness_audit/example.py)
- [Batch drift monitoring](packages/rai-check-ml/examples/ml_drift_monitoring/batch_monitor.py)
- [MLflow and Airflow templates](packages/rai-check-ml/examples/mlops_integrations/)
- [Captured-response LLM and RAG audit suite](packages/rai-check-genai/examples/llm_audit_suite.yml)
- [Scientific image robustness audit](packages/rai-check-dl/examples/scientific_ai/microscopy_audit.py)
- [Agent trace with a webpage prompt-injection attempt](packages/rai-check-genai/examples/customer_support_trace.json)
